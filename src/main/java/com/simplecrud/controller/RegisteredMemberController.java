...
public class RegisteredMemberController {
    ...
    @Autowired
    private UserInfoDao userDao;//userDao
     ...
     * @return view
     */
    @RequestMapping(value = "/registeredmember")//value

    public ModelAndView registeredMember(HttpServletRequest request,//request
            @RequestParam(value = "id", required = false) long id,//id
